...
const u16 gMetatiles_RBY_Outdoors[] = INCBIN_U16("data/tilesets/primary/rby_outdoors/metatiles.bin");
const u16 gMetatileAttributes_RBY_Outdoors[] = INCBIN_U16("data/tilesets/primary/rby_outdoors/metatile_attributes.bin");
